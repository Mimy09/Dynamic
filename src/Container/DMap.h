...
static void DMap_set_bool(DMap* in_map, const char* in_key, bool in_value) { DMap_set(in_map, in_key, &in_value); }
//---}}}
...
static bool* DMap_get_bool(DMap* in_map, const char* in_key) { return (bool*)DMap_get(in_map, in_key); }
//---}}}
