...
static void DArray_put_u8  (DArray* in_arr, uint8_t  in_value, uint32_t in_size) { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_u16 (DArray* in_arr, uint16_t in_value, uint32_t in_size) { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_u32 (DArray* in_arr, uint32_t in_value, uint32_t in_size) { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_u64 (DArray* in_arr, uint64_t in_value, uint32_t in_size) { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_i8  (DArray* in_arr, int8_t  in_value, uint32_t in_size)  { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_i16 (DArray* in_arr, int16_t in_value, uint32_t in_size)  { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_i32 (DArray* in_arr, int32_t in_value, uint32_t in_size)  { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_i64 (DArray* in_arr, int64_t in_value, uint32_t in_size)  { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_f32 (DArray* in_arr, float  in_value, uint32_t in_size)   { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_f64 (DArray* in_arr, double in_value, uint32_t in_size)   { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_char(DArray* in_arr, char  in_value, uint32_t in_size)    { DArray_put(in_arr, &in_value, in_size); }
static void DArray_put_cstr(DArray* in_arr, char* in_value, uint32_t in_size)    { DArray_put(in_arr, &in_value, in_size); }
